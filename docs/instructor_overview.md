...
| 2026-07-15 | **Lab 1** (first full class; date corrected 2026-08-12 from the data — earlier docs said 07-16) | **Ran during the Toronto wildfire-smoke peak**: outdoor PM2.5 median 79 µg/m³, 97% of outdoor readings > 50; N95s (3M 1870+ Aura) issued for outdoor legs. Indoor median 32 = shelter (÷2.5) *and* infiltration (clean-day indoor is 1–3). App + debrief worked; **~half the CSV exports never arrived by email** — including half of the season's most dramatic dataset → v1.1 send/save split, v1.2 one-file config (07-17); Home Base became one tabbed dashboard |
